    ...
    <article className="grid lg:grid-cols-2 px-5 md:px-20 xl:px-52 mt-20 lg:mt-32">
      ...
      <div className="grid justify-center ">
        ...
        <div className="flex justify-start md:justify-end mt-5 md:mt-10">
          <a className="h-8 w-8 lg:h-12 lg:w-12 flex items-center justify-end cursor-pointer md:ml-5 rounded-full bg-gradient ancor">
            <FontAwesomeIcon
          ...
          <a className="h-8 lg:h-12 cursor-pointer ml-5 ancor" href={srcGit} target="_blank" >
